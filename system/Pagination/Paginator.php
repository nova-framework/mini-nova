...
class Paginator implements ArrayableInterface, ArrayAccess, Countable, IteratorAggregate, JsonableInterface
{
     ...
     *
     * @param  \Mini\Pagination\Factory  $factory
     * @param  array     $items
     * @param  int       $total
     ...
     *
     * @return \Mini\Pagination\Presenter
     */
     ...
     *
     * @param \Mini\Pagination\Presenter $presenter
     * @return \Mini\Pagination\Paginator
     */
