...
<!-- Main content -->
<div class="row">
	<h4><?= __('Create a new User Account'); ?></h4>
	<hr>
	...
	<div class="col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2">
		...
		<div class="form-group">
			...
			<div class="col-sm-8">
				<input name="first_name" id="first_name" type="text" class="form-control" value="<?= Input::old('first_name'); ?>" placeholder="<?= __('First Name'); ?>">
			</div>
		</div>
		<div class="form-group">
			<label class="col-sm-4 control-label" for="last_name"><?= __('Last Name'); ?> <font color='#CC0000'>*</font></label>
			<div class="col-sm-8">
				<input name="last_name" id="last_name" type="text" class="form-control" value="<?= Input::old('last_name'); ?>" placeholder="<?= __('Last Name'); ?>">
			</div>
		</div>
		<div class="form-group">
			<label class="col-sm-4 control-label" for="password"><?= __('Password'); ?> <font color='#CC0000'>*</font></label>
			<div class="col-sm-8">
				<input name="password" id="password" type="password" class="form-control" value="" placeholder="<?= __('Password'); ?>">
			</div>
		</div>
		<div class="form-group">
			<label class="col-sm-4 control-label" for="password_confirmation"><?= __('Confirm Password'); ?> <font color='#CC0000'>*</font></label>
				<div class="col-sm-8">
